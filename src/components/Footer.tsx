        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/#floor-plans" className="text-gray-400 hover:text-white transition duration-300">
                  Floor Plans & Pricing
                </Link>
              </li>
              <li>
                <Link href="/#amenities" className="text-gray-400 hover:text-white transition duration-300">
                  Amenities
                </Link>
              </li>
              <li>
                <Link href="/#location" className="text-gray-400 hover:text-white transition duration-300">
                  Location
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">+91 7977144095</span>
              </li>
              <li className="flex items-start">
                {/* <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Stay updated with the latest offers and project updates
            </p>
            <form className="mb-4">
              <div className="flex">
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                />
                <button
                  type="submit"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Adani Realty. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link href="/privacy-policy" className="text-gray-400 hover:text-white text-sm transition duration-300">
                Privacy Policy
              </Link>
              <Link href="/terms-conditions" className="text-gray-400 hover:text-white text-sm transition duration-300">
                Terms & Conditions
              </Link>
              <Link href="/disclaimer" className="text-gray-400 hover:text-white text-sm transition duration-300">
                Disclaimer
              </Link>
            </div>
          </div>
